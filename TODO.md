...
- [x] Improve Border Workspace presentation with stronger contrast, clearer slot-to-preview correspondence, a compact authoring panel, inline/global-specific fields, a centered compact slot grid, a richer `Used By` context panel for global borders, and first-pass CRUD for border sets / global contexts
