...
- [ ] Brush Workspace `Carpet` stage 3: continue the carpet-only visual pass with a richer composed preview and higher-level authoring affordances if the new layout-map + inline-variant flow still feels too list-like in practice
