...
- [ ] Brush Workspace `Carpet` stage 2: add a richer carpet-only preview/authoring pass on top of the new layout-map selection flow, including stronger empty-state affordances and clearer inline variant actions
